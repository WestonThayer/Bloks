...
typedef struct ListStyleSuite{
    ...
    ATEErr (*GetNthLevelLabelFont) ( ListStyleRef listStyle, ATETextDOM::Int32 index, FontRef* ret);
    
    ATEErr (*GetNthLevelSequenceGenerator) ( ListStyleRef listStyle,
                                                ATETextDOM::Int32   index,
    ...
    ATEErr (*SetNthLevelLabelFont)( ListStyleRef listStyle, ATETextDOM::Int32 index, FontRef font);
...
typedef struct ListStyleSetSuite{
    ...
    ATEErr (*Add) ( ListStyleSetRef listStyleset, ListStyleRef listStyle, ATETextDOM::Int32* ret);
