...
public:
    ...
    /** Retrieves the font of label of Nth level in this list object.
        ...
        */
    IFont GetNthLevelLabelFont( ATETextDOM::Int32 index);
    /** Retrieves the Nth Sequence Generator this list object
            @param index : Nth level position
            ...
            @param  bullet -This is the bullet label of Nth level of this list if Nth level is of type BulletSequenceGenerator, else it is invalid
        */
    void GetNthLevelSequenceGenerator(ATETextDOM::Int32   index,
    ...
    /** Sets the Nth level Label Font of  this list object.
        ...
        */
    void SetNthLevelLabelFont(ATETextDOM::Int32 index, IFont font);
    /** Sets the Nth level Label Font of  this list object.
             @param index : Nth level position
...
public:
    ...
    /** Appends a ListStyle to this set.
        ...
        */
    ATETextDOM::Int32 Add( IListStyle listStyle);
