...
namespace ai
{
	...
	*/
	...
	inline bool operator==(const ai::LiteralString& lhs, const char* rhs)
	{
	...
	inline bool operator==(const char* lhs, const ai::LiteralString& rhs)
	{
		return (rhs == lhs);
	}
	...
	inline std::string to_std_string(LiteralString str)
	{
