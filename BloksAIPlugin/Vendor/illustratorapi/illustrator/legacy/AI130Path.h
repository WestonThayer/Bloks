#ifndef __AI130Path__
#define __AI130Path__
...
#define kAI130PathSuite				kAIPathSuite
#define kAIPathSuiteVersion7		AIAPI_VERSION(7)
#define kAI130PathSuiteVersion		kAIPathSuiteVersion7
#define kAI130PathVersion			kAI130PathSuiteVersion
