#ifndef __AI130Runtime__
#define __AI130Runtime__
...
#define kAI130RuntimeSuite			kAIRuntimeSuite
#define kAIRuntimeSuiteVersion9	AIAPI_VERSION(9)
#define kAI130RuntimeSuiteVersion	kAIRuntimeSuiteVersion9
