#ifndef __AI140Context__
#define __AI140Context__
...
#define kAI140AppContextSuite			"AI Context Suite"
#define kAIAppContextSuiteVersion4	AIAPI_VERSION(4)
#define kAI140AppContextVersion		kAIAppContextSuiteVersion4
