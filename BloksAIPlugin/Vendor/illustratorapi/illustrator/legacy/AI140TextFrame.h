#ifndef __AI140TextFrame__
#define __AI140TextFrame__
...
#define kAI140TextFrameSuite			"AI Text Frame Suite"
#define kAITextFrameSuiteVersion1		AIAPI_VERSION(1)
#define kAI140TextFrameSuiteVersion		kAITextFrameSuiteVersion1
#define kAI140TextFrameVersion			kAI140TextFrameSuiteVersion
...
/** @ingroup Suites
	...
	<br> \c #AITextFrameHitSuite
  	...
  	\li Acquire this suite using \c #SPBasicSuite::AcquireSuite() with the constants
		\c #kAI140TextFrameSuite and \c #kAITextFrameVersion.
 */
typedef struct {
	...
	/** Retrieves the anchor point of a point-text text frame.
		Use the \c #AITransformArtSuite to change the anchor point.
			...
			@return #kBadParameter error if the text frame is not a point-text type.
		  */
