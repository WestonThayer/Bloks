#ifndef __AI190Placed__
#define __AI190Placed__
...
#define kAI190PlacedSuiteVersion	kAIPlacedSuiteVersion8
...
*/
struct AI190PlaceRequestData
{
	AI190PlaceRequestData() : m_lPlaceMode(0), m_hOldArt(NULL), m_hNewArt(NULL), m_pFilePath(NULL), m_lParam(0), m_filemethod(0), m_disableTemplate(false), m_doShowParamDialog(false){}
 ...
 */
typedef struct AI190PlacedSuite {
	...
	/** Executes a  request related to a placed object.
		...
		or in relation to the current selection.
			@param placeRequestData An \c #AI190PlaceRequestData structure in which to
				specify the request and return results.
		*/
	AIAPI AIErr(*ExecPlaceRequest)(AI190PlaceRequestData &placeRequestData);
