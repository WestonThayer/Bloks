#ifndef __AI191CursorSnap__
#define __AI191CursorSnap__

/*
 *        Name:	AI191CursorSnap.h
 *      Author:
 *        Date:
...
#define kAI191CursorSnapSuite				"AI Cursor Snap Suite"
#define kAI191CursorSnapSuiteVersion15		AIAPI_VERSION(15)
#define kAI191CursorSnapSuiteVersion		kAI191CursorSnapSuiteVersion15


/**
	Kinds of custom constraints for \c #AI191CursorSnapSuite.
 */
enum {
	/** Single point */
	kAI191PointConstraint = 1,
	/** A line whose angle is relative to the page coordinates */
	kAI191LinearConstraintAbs,
	/**	A line whose angle is relative to the constraint angle	*/
	kAI191LinearConstraintRel
};


/**  Flags for custom constraints: snap to constraint when shift key is down.
  See \c #AI191CursorSnapSuite. */
#define kAI191ShiftConstraint			(1<<0L)


/** Boundary editors for the transformation tools.
See \c #AI191CursorSnapSuite. */
enum {
	kAI191TranslateBoundaryEditor = 1
};
...
/**
	Structure describing a custom constraint for \c #AI191CursorSnapSuite..
 */
struct AI191CursorConstraint {
	...
	*/
	ai::int32				kind;
	/** Flags for the constraint. The only flag is \c #kAI191ShiftConstraint,
	 which means snap to the constraint when the shift key is down.*/
	ai::int32				flags;
	/** Origin point for the constraint. */
	AIRealPoint			point;
	/** When \c kind is \c kAI191LinearConstraintRel, the angle of the line. */
	AIFloat			angle;
...
/** @ingroup Suites
	...
	\li Acquire this suite using \c #SPBasicSuite::AcquireSuite() with the constants
		\c #kAI191CursorSnapSuite and \c #kAI191CursorSnapVersion.
...
struct AI191CursorSnapSuite {
	 ...
	 */
	AIAPI AIErr			(*SetCustom)			(ai::int32 count, const AI191CursorConstraint* constraints);
