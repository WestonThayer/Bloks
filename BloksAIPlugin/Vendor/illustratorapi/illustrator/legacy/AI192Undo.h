#ifndef __AI192Undo__
#define __AI192Undo__
...
#define kAI192UndoSuite				kAIUndoSuite
#define kAI192UndoSuiteVersion		AIAPI_VERSION(7)
#define kAI192UndoVersion			kAI192UndoSuiteVersion


/** For Undo context types, see AIUndo.h */
...
/** @ingroup Suites
	...
	plug-in was called, or to set the text of the Undo/Redo menus.
  	...
  	\li Acquire this suite using \c #SPBasicSuite::AcquireSuite() with the constants
		\c #kAI192UndoSuite and \c #kAIUndoVersion.

	@section UndoContext Undo API Contexts

	The \c AI192UndoSuite allows you to manipulate the undo \e context for your plug-in.
